...
<div class="relative h-full w-auto top-16 xl:top-5 z-0 flex flex-row overflow-hidden">
	<NavbarSpacer />
	<div class="p-1 xl:px-4 flex flex-col gap-2 w-full overflow-hidden">
		...
		<div class="flex flex-row gap-2 overflow-x-auto w-full h-[83svh] xl:h-[90svh] snap-mandatory snap-x">
			<div class="w-[98vw] xl:w-[50vw] h-full flex-shrink-0 lg:flex-shrink snap-center flex flex-col gap-2">
			...
			<div class="w-[98vw] xl:w-[100vw] h-full flex-shrink-0 lg:flex-shrink snap-center flex flex-col gap-2">
